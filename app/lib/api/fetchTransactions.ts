...
export const fetchConfirmedTransactions = async (walletAddress: string): Promise<any[]> => {
...
export const fetchPendingTransactions = async (walletAddress: string): Promise<any[]> => {
